...
data=quandl.get("CHRIS/CME_US1",authtoken="3xzT39gTu4cvgXYqKRRJ")

# Download 30 year T-bond yield data
t_yield=quandl.get("USTREASURY/YIELD",authtoken="3xzT39gTu4cvgXYqKRRJ")
...
the first day of the next month. Each element in whole_x is one month's histoircal data'''
